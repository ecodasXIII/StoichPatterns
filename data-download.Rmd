...
To download files onto your local machine

```{r}
# file_copy(path = wq_data$data_link[c(1:2, 4, 6:13)], 
           # new_path = dir_create("data/water_chemistry/"))
```

```{r}
site_info_data <- nars_data %>% filter(Indicator == "Site Information")
```
